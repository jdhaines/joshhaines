...
```bash
docker-compose -f docker-compose.yml -f production-docker-compose.yml -p prod_elmo down

docker-compose -f docker-compose.yml -f production-docker-compose.yml -p prod_elmo up -d
```
