          ...
          <div className="relative max-w-lg">
            <label>
              ...
              <input
                ...
                className="focus:border-jblue-500 focus:ring-jblue-500 block w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 dark:border-gray-900 dark:bg-gray-800 dark:text-gray-100"
              />
            </label>
            <svg
