...
description: Cheatsheet for interacting with a postgres database inside a docker container.
...
ssh uid@exlab-lin02.domain.local
...
sudo rsync --chown=uid:group -avzhe ssh /var/lib/pgsql/backups/backupname.bak uid@exlab-lin01.domain.local:var/www/project

# Real example
sudo rsync --chown=u1019077:sgg-cs-prj-exlab-cpt-eng -avzhe ssh /var/lib/pgsql/backups/elmo-2019-09-27_18\:00.bak u1019077@exlab-lin01.domain.local:/var/www/elmov2
