...
| 12 | Infosec and IA need to be involved throughout, can't be a bottleneck at the end as changes are hard and expensive. Plus it slows down our goal of fast deployments |
| 13 | Rugged Manifesto is an alternative to DevSecOps |
...
| 17 | Yak days (for technical debt) and half days (for other work). |
| 18 | Allocate a training budget and let employees use it how they see fit. |
