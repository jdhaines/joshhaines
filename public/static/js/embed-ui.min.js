...
;(function () {
  ...
  function p(a, b) {
    ...
    a.Ic = function (d, f, g) {
      for (var k = Array(arguments.length - 2), u = 2; u < arguments.length; u++)
        k[u - 2] = arguments[u]
  ...
  Ta.prototype.add = function (a, b, c, d, f) {
    ...
    ;-1 < k
      ? ((b = a[k]), c || (b.sa = !1))
      : ((b = new Ra(b, this.src, g, !!d, f)), (b.sa = c), a.push(b))
    return b
  }
  function Va(a, b) {
    var c = b.type
  ...
  function Xa(a, b) {
    ...
    return ra(a.a, function (g) {
      for (var k = 0; k < g.length; ++k)
        if (!((c && g[k].type != d) || (f && void 0 != g[k].capture))) return !0
      return !1
    })
  }
  function Ua(a, b, c, d) {
  ...
  var ab = r('Opera'),
    ...
    cb =
      r('Gecko') &&
      !(-1 != za.toLowerCase().indexOf('webkit') && !r('Edge')) &&
      !(r('Trident') || r('MSIE')) &&
      !r('Edge'),
  ...
  function xb(a, b, c, d, f, g) {
    ...
    if (a.addEventListener)
      (ob || (f = k), void 0 === f && (f = !1), a.addEventListener(b.toString(), d, f))
    ...
    if (this.W) {
      ...
      0 < a && a < 0.8 * this.a
        ...
        : (this.U && (this.b.clearTimeout(this.U), (this.U = null)),
          A(this, 'tick'),
          this.W && ((this.U = this.b.setTimeout(this.i, this.a)), (this.m = la())))
    }
  }
  e.start = function () {
    this.W = !0
  ...
  function Zb(a) {
    ...
    if (
      Pb &&
      !(w && jb('9') && !jb('10') && h.SVGElement && a instanceof h.SVGElement) &&
      (b = a.parentElement)
    )
      return b
    b = a.parentNode
  ...
  function ac(a, b) {
    ...
    if (!c) {
      ...
      c = d
      void 0 === a.style[d] &&
        ((d = (db ? 'Webkit' : cb ? 'Moz' : w ? 'ms' : ab ? 'O' : null) + ya(d)),
  ...
  function hc(a) {
    ...
    if (
      c &&
      'CSS1Compat' == Qb(b).a.compatMode &&
      'auto' != c.width &&
      'auto' != c.height &&
      !c.boxSizing
    )
      return (
        (b = ic(a, c.width, 'width', 'pixelWidth')),
        (a = ic(a, c.height, 'height', 'pixelHeight')),
        new C(b, a)
      )
    ...
    if (w) {
      ...
      ((b = cc(a, 'paddingLeft')),
        (d = cc(a, 'paddingRight')),
        (f = cc(a, 'paddingTop')),
        (g = cc(a, 'paddingBottom')),
        (b = new Mb(parseFloat(f), parseFloat(d), parseFloat(g), parseFloat(b))))
    !w || 9 <= Number(kb)
      ? ((d = cc(a, 'borderLeftWidth')),
        (f = cc(a, 'borderRightWidth')),
        (g = cc(a, 'borderTopWidth')),
        (a = cc(a, 'borderBottomWidth')),
        (a = new Mb(parseFloat(g), parseFloat(f), parseFloat(a), parseFloat(d))))
      : ((d = kc(a, 'borderLeft')),
        (f = kc(a, 'borderRight')),
        (g = kc(a, 'borderTop')),
        (a = kc(a, 'borderBottom')),
  ...
  function Ec(a, b, c) {
    a = Math.round(
      Math.sqrt(Math.pow(a.j.width, 2) + Math.pow(a.j.height, 2)) /
        Math.sqrt(Math.pow(a.h.width, 2) + Math.pow(a.h.height, 2))
    )
        ...
        (a.a
          ...
          : ((a.C = Bc * (null === a.l ? 0.3 : 1)),
            ...
            a.a ||
              ...
              E(a.a, Jc),
              (b = a.C),
              E(a.a, 'transition', 0 < b ? 'opacity ' + 0.001 * b + 's ease' : 'none'),
              x(a.a, 'load', a.Db, !1, a)),
            E(a.a, 'z-index', 2),
            F(a.a, 0),
            (a.a.src = c.src)))
  ...
  function Kc(a) {
    ...
    var d = b.width / b.height,
      ...
      k = a.K
    if ((a.V && (c.width > b.width || c.height > b.height)) || g || k)
      ((d = d > f),
        (!k && d) || (k && !d)
          ? ((c.width = b.height * f), (c.height = b.height))
          : ((c.width = b.width), (c.height = b.width / f)))
  ...
  Pc.prototype.Fa = function () {
    ...
    if (this.i != this.a.length) {
      ...
      for (b = a = 0; a < this.a.length; )
        ((c = this.a[a]),
          Object.prototype.hasOwnProperty.call(d, c) || ((this.a[b++] = c), (d[c] = 1)),
          a++)
      this.a.length = b
    }
  ...
  function pd(a, b) {
    ...
    try {
      ;(sd(a),
        0 < a.F &&
          ((a.j = td(a.a)),
          Q(a.b, qd(a, 'Will abort after ' + a.F + 'ms if incomplete, xhr2 ' + a.j)),
          a.j ? ((a.a.timeout = a.F), (a.a.ontimeout = m(a.ib, a))) : (a.h = Kb(a.ib, a.F, a))),
  ...
  e.ib = function () {
    'undefined' != typeof aa &&
      this.a &&
      ((this.B = 'Timed out after ' + this.F + 'ms, aborting'),
      Q(this.b, qd(this, this.B)),
      A(this, 'timeout'),
      this.abort(8))
  }
  function rd(a, b) {
  ...
  e.N = function () {
    this.a &&
      (this.i && ((this.i = !1), (this.m = !0), this.a.abort(), (this.m = !1)), vd(this, !0))
    hd.g.N.call(this)
  }
  e.$a = function () {
  ...
  function wd(a) {
    if (a.i && 'undefined' != typeof aa)
      if (a.L[1] && 4 == xd(a) && 2 == yd(a))
        Q(a.b, qd(a, 'Local request error detected and ignored'))
  ...
  function vd(a, b) {
    if (a.a) {
      ...
      try {
        ...
        ;(a = a.b) &&
          a.log(ad, 'Problem encountered resetting onreadystatechange: ' + f.message, void 0)
      }
    }
  }
  function sd(a) {
  ...
  function P(a, b) {
    if (a.classList) a.classList.add(b)
      ...
      if (a.classList) var c = !a.classList.contains(b)
        ...
        (a.classList
          ? (c = a.classList)
          : ((c = a.className), (c = (l(c) && c.match(/\S+/g)) || [])),
          (c = !(0 <= Ca(c, b))))
  ...
  function S(a, b) {
    'boolean' == typeof a
      ? (b = !0 === a)
      : l(a)
        ? ((a = a.toLowerCase()), (b = 'true' === a ? !0 : 'false' === a ? !1 : !0 === b))
        : (b = !0 === b)
    return b
  }
  function Xd(a) {
    ...
    b instanceof Element &&
      (t(
        ...
        function (f) {
          ...
          k &&
            ((f = f.getAttribute('type') || 'image/jpeg'), (g.src = k), (g.mimetype = f), Ga(d, g))
        },
        a
      ),
      t(
  ...
  function ze(a, b) {
    ...
    switch (b.a) {
      ...
      default:
        ...
        null !== b.width &&
          ...
          null !== b.height &&
          0 < b.height &&
          ((d.u = new C(b.width, b.height)), O(d) && ((d.j = hc(d.c())), Lc(d)))
        d.J = b.aspectRatio
        O(d) && Lc(d)
        d.R = b.Ea
        O(d) && Lc(d)
    ...
    l(b.description) &&
      ((c = new ae()), (c.b = b.description), O(c) && $b(c.a, null !== c.b ? c.b : ''), a.T(c, !0))
  }
  e.pb = function () {
  ...
  function Ee(a, b) {
    De(
      a,
      'https://www.publicalbum.org/v1/json/story?id=' + b + '&origin=' + location.hostname,
      function (c) {
        var d = this.Y
        ...
        f &&
          ((d.Ra = q(f, 'name') || null),
          (d.lb = q(f, 'url') || null),
          (d.Qa = q(q(f, 'image'), 'url') || null))
        d.link =
          q(c, 'url') || (d.link && d.link.match(/publicalbum|google|goo\.gl/) ? d.link : null)
  ...
  function Ue(a) {
    var b = a.o
    E(a.a.c(), {
      width: (a.s ? 0.6 * b.width : b.width) + 'px',
      height: (a.s ? 0.6 * b.height : b.height) + 'px',
      'border-radius': 0.5 * Math.min(b.width, b.height) + 'px',
    })
  }
  ...
  var hf = {
    ...
    jf = {
      ...
      background:
        'linear-gradient(to bottom, rgba(0,0,0,0.33) 0%, rgba(0,0,0,0.02) 88%, rgba(0,0,0,0) 100%)',
    },
  ...
  Ag.prototype.f = function (a) {
    ...
    a &&
      1 == a.length &&
      (B(this, 'gtouchhmove') || B(this, 'gtouchvmove')
        ? ((this.i.a = a[0].clientX), (this.i.b = a[0].clientY), (this.b = null))
        : B(this, 'gtouchstart') && ((b = new Cg('gtouchstart', this, a)), A(this, b)),
  ...
  Ag.prototype.F = function (a) {
    ...
    if (c || d) {
      if (
        !this.b &&
        ((this.b = Math.abs(this.i.a - b[0].clientX) > Math.abs(this.i.b - b[0].clientY) ? 1 : 2),
        B(this, 'gtouchstart'))
      ) {
      ...
      c &&
        1 == this.b &&
        ((f = new Cg('gtouchhmove', this, b)), A(this, f), a.stopPropagation(), a.a())
      d &&
        2 == this.b &&
        ((f = new Cg('gtouchvmove', this, b)), A(this, f), a.stopPropagation(), a.a())
    }
  ...
  Ag.prototype.B = function (a) {
    ...
    if (
      1 == a.length &&
      (Cb(this.a, 'touchmove', this.F, !1, this),
      Cb(this.a, 'touchend', this.B, !1, this),
      B(this, 'gtouchend'))
    ) {
  ...
  Dg.prototype.F = function (a) {
    ...
    a.a()
    this.a ||
      ((a = a.touches[0].clientX), (this.a = !0), (this.f = a), A(this, new Eg('cgtart', a)))
  }
    ...
    if (0 != K(a))
      if (a.b != a.a && null != a.a)
        ((a.j = !0),
          ...
          Pg(a),
          Qg(a),
          a.j ? window.requestAnimationFrame(m(a.Cc, a)) : a.gb(),
          (a.s = setTimeout(m(a.jb, a), 1.2 * a.G)))
      else if (0 == a.a && 0 == a.b) {
        var b = L(a, 0)
        if (b) {
          var c = b.c()
  ...
  e.update = function () {
    ...
    this.H &&
      (this.C
        ? (this.a.setAttribute('href', this.C),
          this.a.setAttribute('target', 'parent'),
          E(this.a, fh))
        : (this.a.removeAttribute('href'), this.a.removeAttribute('target'), E(this.a, gh)))
