...
GitHub automatically makes `.github/copilot-instructions.md` available to supported Copilot interactions in the repository. It also supports path-specific instructions and `AGENTS.md` files; when an agent is operating within a directory tree, the nearest applicable `AGENTS.md` takes precedence. :contentReference[oaicite:2]{index=2}
