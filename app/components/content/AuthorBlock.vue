...
const socialLinks = computed(() => {
  return [
    props.author.linkedin && {
      ...
      to: props.author.linkedin,
      label: "LinkedIn",
    },
    props.author.github && {
      icon: "i-simple-icons-github",
      to: props.author.github,
      label: "GitHub",
    },
    props.author.discord && {
...
<template>
  ...
  >
    ...
    <div>
      ...
      <p v-if="author.occupation" class="mb-2 text-sm text-muted">
        {{ author.occupation
      ...
      />
      <div v-if="socialLinks.length" class="mt-3 flex gap-3">
        <UButton
