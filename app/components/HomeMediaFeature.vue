...
<template>
  <section aria-labelledby="home-media-feature-heading" class="rounded-xl border border-default bg-elevated/40 p-6 sm:p-10">
    <HomeSectionEyebrow id="home-media-feature-heading" :label="eyebrow" />

    <div class="grid gap-6 sm:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] sm:items-center sm:gap-10">
